    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] text-center animate-fade-in px-4">
        ...
        <p className="text-lg text-muted-foreground max-w-md">
          Setting up <span className="font-semibold text-primary">{profile.restaurantName}</span> on Homemade
        </p>
      </div>
    );
  }
  ...
  return (
    <div className={`flex flex-col items-center justify-center min-h-[70vh] text-center px-4 ${showContent ? 'animate-fade-in' : 'opacity-0'}`}>
      ...
      <p className="text-xl text-muted-foreground mb-8 max-w-lg animate-slide-up" style={{ animationDelay: '0.1s' }}>
        <span className="font-semibold text-primary">{profile.restaurantName}</span> is ready. Next, we'll help you finish your menu and go live.
      </p>

      {/* Profile Summary with Logo */}
