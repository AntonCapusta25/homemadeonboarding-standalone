...
export function FoodSafetyStep({ value, certificateUrl, onChange, onNext, onPrevious }: FoodSafetyStepProps) {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        ...
        onChange('has_certificate', event.target?.result as string);
      };
  ...
  return (
    <StepLayout
      ...
      subtitle={t('foodSafety.subtitle')}
      onNext={onNext}
        ...
        <div className="grid gap-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-display font-semibold text-foreground mb-1">
                  {t('foodSafety.haveCertificate')}
                </h3>
                <p className="text-sm text-muted-foreground">
                  {t('foodSafety.haveCertificateDesc')}
                </p>
                  ...
                  <div className="mt-4 animate-slide-up">
                    ...
                    {uploadedFile ? (
                      ...
                      >
                        ...
                        {t('foodSafety.uploadCertificate')}
                      </Button>
                    )}
                  </div>
                )}
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-display font-semibold text-foreground mb-1">
                  {t('foodSafety.noCertificate')}
                </h3>
                <p className="text-sm text-muted-foreground">
                  {t('foodSafety.noCertificateDesc')}
                </p>
              </div>
              <div
                className={cn(
