      ...
      <div className="min-h-screen bg-gradient-soft">
        <div className="container max-w-4xl mx-auto px-4 py-8">
          <div className="flex flex-col items-center justify-center min-h-[70vh] text-center animate-fade-in px-4">
            ...
            <p
              className="text-xl text-muted-foreground mb-8 max-w-lg animate-slide-up"
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-slide-up" style={{ animationDelay: "0.3s" }}>
              <Button size="xl" onClick={handleGetStarted} className="shadow-glow hover:shadow-medium">
